...
class Algorithm:
    ...
    def _calculate_ratio(self):
        ...
        self.x_offset = x_offset = (x_max + x_min) * 0.5
        self.y_offset = y_offset = (y_max + y_min) * 0.5

        # <3> Compensate hard iron offset <\>
        ds_hard_iron = [(x - x_offset, y -y_offset) for (x,y) in self.ds]
